...
const (
	...
	// Equivalent to passing in the same expiration duration as was given
...
// LoadFile loads and add caches items from the given filename, excluding any items with
